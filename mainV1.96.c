    ...
    do {
        ...
        switch (opcion) {
            ...
            case 3:
                ...
                printf("4. Si quieres hacer mas grande la tabla puedes ir al apartado numero 4 del menu principal,\n   ten en consideracion que un numero muy grande puede poca visibilidad de si misma,\n   el numero maximo es de 16, asi que ten en cuenta este limite.\n");
